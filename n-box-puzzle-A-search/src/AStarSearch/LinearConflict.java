...
//        n=n*n-1;
        ...
        if (isInv == 1) {
            ...
            while (true) {
                ...
                if (searchNode.linearConflict(searchNode.current, rc) == 0) {
...
//                leftNode.printMatrix(rc);
                int upH = currentNode.linearConflict(up, rc);
                int downH = currentNode.linearConflict(down, rc);
                int rightH = currentNode.linearConflict(right, rc);
                int leftH = currentNode.linearConflict(left, rc);
